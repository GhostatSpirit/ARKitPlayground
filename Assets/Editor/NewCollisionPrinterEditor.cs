...
namespace LlockhamIndustries.Decals
{
    ...
    [CustomEditor(typeof(NewCollisionPrinter))]
    public class NewCollisionPrinterEditor : PrinterEditor
    {
        SerializedProperty rotationSource;
        SerializedProperty condition;
        SerializedProperty conditionTime;
        SerializedProperty layers;
		SerializedProperty useTransformForward;
        ...
        public override void OnEnable()
        {
			...
			useTransformForward = serializedObject.FindProperty("useTransformForward");
        }
		...
		private void TransformForwardGUI()
		{
			EditorGUILayout.LabelField(new GUIContent("Use Transform Forward", "use this transform's forward as decay normal?"));
			EditorGUI.indentLevel++;
			EditorGUILayout.PropertyField(useTransformForward, new GUIContent("", "use this transform's forward as decay normal?"));
		}
    }
}