...
namespace LlockhamIndustries.Decals
{
    ...
    */
	...
	public class NewCollisionPrinter : Printer
	{
		/**
        ...
        */
		...
		public void PrintCollision(Collision collision)
		{
			...
			if (validContacts > 0)
			{
				...
				RaycastHit hit;
				// YANG: modified scale of raycast
				if (Physics.Raycast(position + (normal * 0.03f), -normal, out hit, 0.04f, layers.value))
				{
					position = hit.point;
...
//					Debug.Log ("surface: " + surface.ToString());
